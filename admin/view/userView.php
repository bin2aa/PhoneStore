        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a
                        href="index.php?ctrl=userController&action=toggleUserStatus&id=<?php echo $user['id']; ?>&status=<?php echo $user['trang_thai']; ?>">
                        <?php
                ...
                <td>
                    <a class="deleteUserLink"
                        href="index.php?ctrl=userController&action=deleteUser&id=<?php echo $user['id']; ?>">Xóa</a>
                    <a class="updateUserLink"
                        href="index.php?ctrl=userController&action=updateUserView&id=<?php echo $user['id']; ?>&vai_tro=<?php echo $user['vai_tro']; ?>">Sửa</a>
                </td>
