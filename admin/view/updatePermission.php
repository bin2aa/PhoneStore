...
<body>
    <div class="updatePermission">
        ...
        <form class="permissionSubmitUd" method="POST"
            action="index.php?ctrl=permissionController&action=updatePermission">
