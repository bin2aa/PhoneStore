...
<body>
    <div class="product-detail">
        ...
        <div class="right-column">
            ...
            <a href="index.php?ctrl=cartController&action=addToCart&cart_id=<?php echo $product['id']; ?>&quantity=1"
                class="buy-button">Thêm vào giỏ hàng</a>
            <?php } else { ?>
            ...
            <div class="comment-section">
                ...
                <div class="comment" id="comment-<?php echo $comment['id']; ?>">
                    <p class="author"><?php echo "ID: " . $comment['id_khach_hang']; ?> -
                        <?php echo "Tên: " . $comment['ten_khach_hang']; ?> -
                        <?php echo $comment['ngay_gio_binh_luan']; ?></p>
