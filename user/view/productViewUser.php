...
<body>
    ...
    <div class="category-list">
        <ul class="category-items">
            <li class="category-item"><a href="index.php?ctrl=productControllerUser" class="category-link">tất cả</a>
            </li>
            <?php
            if (!empty($categories)) {
    ...
    <div class="product-list" id="product-list">
        ...
        <div class="product">
            ...
            <a href="#" class="buy-button"
                data-product-id="<?php echo $product['id']; ?>"><?php echo $product['so_luong'] > 0 ? 'Thêm vào giỏ hàng' : 'Tạm hết hàng'; ?></a>
...
$(document).ready(function() {
    ...
    $('.buy-button').on('click', function(e) {
        ...
        $.ajax({
            url: 'index.php?ctrl=cartController&action=addToCart' + '&cart_id=' + productId +
                '&quantity=' + quantity,
            type: 'POST',
            data: data,
            success: function(response) {
