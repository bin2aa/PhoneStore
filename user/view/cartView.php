...
<body>
    <div class="CartContent">
        ...
        <div class="cart-items-form">
            <a href="index.php?ctrl=cartController&action=clearCart"
                onclick="return confirm('Bạn có chắc chắn muốn xóa toàn bộ giỏ hàng?');">Xóa toàn bộ giỏ hàng</a>
            ...
            <div class="cart-item" id="cart-item">
                ...
                <div class="item-total">
                    ...
                    <a class='remove-from-cart'
                        href="index.php?ctrl=cartController&action=removeFromCart&cart_id=<?php echo $productId; ?>"><i
            ...
            <form id='buyAllForm' class='buyAll' method="post" action="index.php?ctrl=cartController&action=createOrder"
                onsubmit='return checkLoggedIn()'>
                ...
                <select name="discount_program">
                    ...
                    <option value="<?php echo $discountProgram['id']; ?>">
                        <?php echo $discountProgram['ten']; ?> - Giảm
                        <?php echo $discountProgram['phan_tram_giam_gia']; ?>% cho đơn hàng từ
                        <?php echo number_format($discountProgram['dieu_kien_mua']); ?>đ trở lên
                    </option>
                    <?php endforeach; ?>
                </select><br><br>
...
$(document).ready(function() {
    $(document).on('submit', '#buyAllForm', function(e) {
        ...
        var discount_program = $('select[name="discount_program"]')
            .val(); // Thêm dòng này để lấy chương trình giảm giá từ select
        data = {
