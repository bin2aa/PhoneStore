...
<head>
    ...
    <style>
        ...
        .tag:hover img{
            transform: translateY(-7px) rotate(15deg) scale(1.3);
        }
        .tag{
            display: flex;
            flex-direction: row;
    ...
    <div class="header">
        ...
        <div class="menu">
            <ul class="menu-list">
                ...
                ?>
                <li class="tag"> 
                    <div class="icon"><img src="/admin/img/icon/cart2.png" alt="cart"></div>
                    <a href="index.php?ctrl=cartController&action=showCart" class="menu-item">Giỏ hàng</a>
                </li>
            </ul>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-12">
                    ...
                    <div class="d-flex flex-column flex-wrap">
                        ...
                        <a href="#" class="text-white-50 pb-1">mssv-4</a>
